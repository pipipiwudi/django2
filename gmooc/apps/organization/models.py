...
class CourseOrg(models.Model):
    ...
    add_time = models.DateTimeField(default=datetime.now, verbose_name='添加时间')
    category = models.CharField(max_length=20, default='pxjg', verbose_name='机构类别', choices=(('pxjg', '培训机构'), ('gx', '高校'), ('gr', '个人')))
...
class Teacher(models.Model):
    ...
    work_postion = models.CharField(max_length=50, verbose_name='职位')
